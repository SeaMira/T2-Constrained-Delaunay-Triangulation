...
int main(int argc, char const* argv[]) {
    ...
    mesh.add_restriction(Vertex(-SIZE/2.0, -SIZE/2.0), Vertex(SIZE/2.0, -SIZE/2.0));
    mesh.add_restriction(Vertex(SIZE/2.0, -SIZE/2.0), Vertex(SIZE/2.0, -SIZE/3.0));
    mesh.add_restriction(Vertex(SIZE/2.0, -SIZE/3.0), Vertex(-SIZE/3.0, -SIZE/3.0));
    mesh.add_restriction(Vertex(-SIZE/3.0, -SIZE/3.0), Vertex(-SIZE/3.0, SIZE/3.0));
    mesh.add_restriction(Vertex(-SIZE/3.0, SIZE/3.0), Vertex(SIZE/2.0, SIZE/3.0));
    mesh.add_restriction(Vertex(SIZE/2.0, SIZE/3.0), Vertex(SIZE/2.0, SIZE/2.0));
    mesh.add_restriction(Vertex(SIZE/2.0, SIZE/2.0), Vertex(-SIZE/2.0, SIZE/2.0));
